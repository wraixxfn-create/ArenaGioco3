...
export const ACHIEVEMENTS = [
  ...
  { id: 'insured', name: 'Covered for All Winds', icon: '🛡️', desc: 'Hold an active underwriters\u2019 charter.', test: (s) => !!s.player.insurance },
  { id: 'star_officer', name: 'Salt and Starlight', icon: '★', desc: 'An officer becomes a veteran (20 legs).', test: (s) => s.player.crew.some((c) => c.star) },
  { id: 'den_regular', name: 'Friend of the Dens', icon: '🕳️', desc: 'Fence 10 crates of contraband through Syndicate dens.', test: (s) => (s.player.stats.smuggled || 0) >= 10 },
